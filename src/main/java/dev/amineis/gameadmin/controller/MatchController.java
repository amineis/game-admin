...
public class MatchController {
  ...
  @GetMapping("/by-game")
  @Operation(
      summary = "List matches by game",
      description = "Returns matches for a given game id (paginated).")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
    @ApiResponse(responseCode = "403", description = "Forbidden")
  ...
  @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
  public ResponseEntity<PagedResponse<MatchResponse>> getMatchesByGameId(
  ...
  @Operation(
      ...
      description = "Returns matches filtered by status (CREATED, STARTED, FINISHED, CANCELLED).")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
    @ApiResponse(responseCode = "403", description = "Forbidden")
  ...
  @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
  public ResponseEntity<PagedResponse<MatchResponse>> getMatchesByStatus(
      @RequestParam MatchStatus status, Pageable pageable) {
    return ResponseEntity.ok(matchService.getMatchesByStatus(status, pageable));
  }

  @GetMapping("/by-region")
  @Operation(
      summary = "List matches by region",
      description = "Returns matches filtered by region (paginated).")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
    @ApiResponse(responseCode = "403", description = "Forbidden")
  ...
  @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
  public ResponseEntity<PagedResponse<MatchResponse>> getMatchesByRegion(
      @RequestParam String region, Pageable pageable) {
  ...
  @Operation(
      ...
      description = "Creates a new match. Requires ADMIN or MODERATOR.")
  @ApiResponses({
  ...
  public ResponseEntity<MatchResponse> updateMatch(
      @PathVariable Long id, @Valid @RequestBody MatchUpdateRequest request) {
  ...
  @Operation(
      ...
      description = "Deletes a match by id. Returns 204 No Content.")
  @ApiResponses({
  ...
  @Operation(
      summary = "Get players in match",
      description = "Returns the list of players assigned to a match.")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
    @ApiResponse(responseCode = "403", description = "Forbidden"),
  ...
  @Operation(
      ...
      description = "Adds a player to an existing match with team and score.")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "400", description = "Validation error"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
  ...
  public ResponseEntity<MatchPlayerResponse> addPlayerToMatch(
      @PathVariable Long matchId, @Valid @RequestBody MatchPlayerRequest request) {
  ...
  @Operation(
      ...
      description = "Removes a player from a match. Returns 204 No Content.")
  @ApiResponses({
