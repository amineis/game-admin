...
public class AppUserController {
  ...
  @Operation(
      ...
      description = "Returns a paginated list of app users. Requires ADMIN.")
  @ApiResponses({
  ...
  @GetMapping("/by-role")
  @Operation(
      summary = "List app users by role",
      description = "Returns app users filtered by role (ADMIN, MODERATOR, SUPPORT).")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
    @ApiResponse(responseCode = "403", description = "Forbidden")
  ...
  @PreAuthorize("hasAuthority('ADMIN')")
  public ResponseEntity<PagedResponse<AppUserResponse>> getAppUsersByRole(
      @RequestParam Role role, Pageable pageable) {
  ...
  public ResponseEntity<AppUserResponse> updateAppUser(
      @PathVariable Long id, @Valid @RequestBody AppUserUpdateRequest request) {
  ...
  @Operation(
      ...
      description = "Deletes an app user by id. Returns 204 No Content.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description =
          "Returns the current authenticated user's username and email from JWT. Any authenticated user.")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "401", description = "Unauthorized")
  })
