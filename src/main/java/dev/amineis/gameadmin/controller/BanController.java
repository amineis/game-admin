...
public class BanController {
    ...
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "Success"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden"), @ApiResponse(responseCode = "404", description = "Ban not found") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
    ...
    @GetMapping("/by-game")
    @Operation(summary = "List bans by game", description = "Returns bans for the given game id (paginated).")
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "Success"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
    ...
    @Operation(summary = "List bans by moderator", description = "Returns bans issued by the given app user id (paginated).")
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "Success"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
    ...
    @Operation(summary = "Create ban", description = "Bans a player for a game. Requires ADMIN or MODERATOR. Moderator is taken from JWT.")
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "Created"), @ApiResponse(responseCode = "400", description = "Validation error"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden"), @ApiResponse(responseCode = "404", description = "Player or game not found") })
    ...
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "Success"), @ApiResponse(responseCode = "400", description = "Validation error"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden"), @ApiResponse(responseCode = "404", description = "Ban not found") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR')")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete ban (unban)", description = "Removes a ban by id. Returns 204 No Content.")
    @ApiResponses({ @ApiResponse(responseCode = "204", description = "Deleted"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden"), @ApiResponse(responseCode = "404", description = "Ban not found") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR')")
