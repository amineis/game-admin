...
public class PlayerController {
    ...
    @GetMapping
    @Operation(summary = "List all players", description = "Returns a paginated list of players. Requires ADMIN, MODERATOR or SUPPORT.")
    ...
    @GetMapping("/search")
    @Operation(summary = "Search players by username", description = "Returns players whose username contains the given string (paginated).")
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "Success"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
    ...
    @Operation(summary = "List players by country", description = "Returns players filtered by 2-letter country code (paginated).")
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "Success"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
    ...
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "Success"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden"), @ApiResponse(responseCode = "404", description = "Player not found") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
    ...
    @PostMapping
    @Operation(summary = "Create player", description = "Creates a new player. Requires ADMIN or MODERATOR.")
    ...
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "Success"), @ApiResponse(responseCode = "400", description = "Validation error"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden"), @ApiResponse(responseCode = "404", description = "Player not found") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR')")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete player", description = "Deletes a player by id. Returns 204 No Content.")
    @ApiResponses({ @ApiResponse(responseCode = "204", description = "Deleted"), @ApiResponse(responseCode = "401", description = "Unauthorized"), @ApiResponse(responseCode = "403", description = "Forbidden"), @ApiResponse(responseCode = "404", description = "Player not found") })
    @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR')")
