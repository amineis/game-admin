...
public class ReportController {
  ...
  @Operation(
      ...
      description = "Returns a paginated list of player reports.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Returns reports filtered by status (PENDING, REVIEWED, REJECTED, BANNED).")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
    @ApiResponse(responseCode = "403", description = "Forbidden")
  ...
  public ResponseEntity<PagedResponse<ReportResponse>> getReportsByStatus(
      @RequestParam ReportStatus status, Pageable pageable) {
    return ResponseEntity.ok(reportService.getReportsByStatus(status, pageable));
  }

  @GetMapping("/by-reported-player")
  @Operation(
      summary = "List reports by reported player",
      description = "Returns reports for the given reported player id (paginated).")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
    @ApiResponse(responseCode = "403", description = "Forbidden")
  ...
  @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
  public ResponseEntity<PagedResponse<ReportResponse>> getReportsByReportedPlayer(
      @RequestParam Long playerId, Pageable pageable) {
    return ResponseEntity.ok(reportService.getReportsByReportedPlayer(playerId, pageable));
  }

  @GetMapping("/by-reporter-player")
  @Operation(
      summary = "List reports by reporter player",
      description = "Returns reports submitted by the given player id (paginated).")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
    @ApiResponse(responseCode = "403", description = "Forbidden")
  ...
  @PreAuthorize("hasAnyAuthority('ADMIN','MODERATOR','SUPPORT')")
  public ResponseEntity<PagedResponse<ReportResponse>> getReportsByReporterPlayer(
      @RequestParam Long playerId, Pageable pageable) {
  ...
  @Operation(
      ...
      description =
          "Creates a new player report. Any authenticated user with MODERATOR/SUPPORT can submit.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Updates a report (e.g. status). Requires MODERATOR or ADMIN.")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Success"),
    @ApiResponse(responseCode = "400", description = "Validation error"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
  ...
  public ResponseEntity<ReportResponse> updateReport(
      @PathVariable Long id, @Valid @RequestBody ReportUpdateRequest request) {
  ...
  @Operation(
      ...
      description = "Deletes a report by id. Returns 204 No Content.")
  @ApiResponses({
